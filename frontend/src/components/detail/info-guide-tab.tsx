  ...
  return (
    <div className="flex items-center justify-between py-2">
      ...
      {value ? (
        ...
        <Button variant="ghost" size="sm" className="h-6 gap-1 text-xs text-primary">
...
export default function InfoGuideTab({ project }: InfoGuideTabProps) {
  ...
  const totalDuration = project.chapterDurations.reduce(
    (a, b) => a + b,
    0
  );
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Work Links */}
      <div>
        <h3 className="text-sm font-medium mb-3">작업 링크</h3>
      ...
      {/* Guide Links (MVP: external links) */}
      <div>
        <h3 className="text-sm font-medium mb-3">가이드 문서</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          <Card className="cursor-pointer hover:bg-accent/30 transition-colors">
            <CardContent className="p-4 flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium">촬영 가이드</p>
          ...
          <Card className="cursor-pointer hover:bg-accent/30 transition-colors">
            <CardContent className="p-4 flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium">편집 · 검수 가이드</p>
                <p className="text-xs text-muted-foreground">
                  편집 기준, 검수 체크리스트
                </p>
              </div>
