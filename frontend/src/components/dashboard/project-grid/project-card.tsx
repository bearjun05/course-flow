...
export function ProjectCard({
  ...
  return (
    <div className="group relative rounded-2xl border-0 bg-card p-4 shadow-[0_2px_14px_rgba(120,100,80,0.08)] transition-all hover:shadow-[0_4px_22px_rgba(120,100,80,0.14)]">
