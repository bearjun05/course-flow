...
| [범위정의문서](범위정의문서%202fb2dc3ef51480a68042cc8ddb110f20.md) | 관리 대상 강의의 범위 (사업부/제작유형/공정) |
| [프로세스정의서](프로세스정의서%202fb2dc3ef514808e9639cd90a41825ba.md) | AS-IS/TO-BE 프로세스, MVP 구성, 추후 우선순위 |
| [킥오프 회의록](kickoff%20회의록.md) | 2026.02.04 킥오프 미팅 내용 및 CTA |
| [상태값목록](상태값목록.md) | 프로젝트 및 태스크 상태값 정의 |
| [촬영 타임라인 관리](촬영%20타임라인%20관리/) | PM이 기존에 사용하던 노션 워크스페이스 (AS-IS 실데이터) |
| [PM 워크플로우](PM-워크플로우.md) | PM 관점의 강의 제작 전 과정 워크플로우 |
| [PM 미팅 노트 (2026.03.05)](PM-미팅-20260305.md) | 개발 착수 전 PM 미팅 — 문제 정의 정교화, MVP 페이지 구조 확정 |
| [파트장 싱크업 (2026.03.06)](파트장-싱크업-20260306.md) | 파트장 싱크업 — MVP 기능/산출물/일정/역할 공유 |
